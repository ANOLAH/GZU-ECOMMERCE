...
$customer_campus = $row_customer['customer_campus'];

$customer_res = $row_customer['customer_res'];
...
<form action="" method="post" enctype="multipart/form-data"><!-- form Begin -->
    ...
    <div class="form-group"><!-- form-group Begin -->
        ...
        <label> Costumer campus: </label>
        
        <input type="text" name="c_campus" class="form-control" value="<?php echo $customer_campus; ?>" required>
    ...
    <div class="form-group"><!-- form-group Begin -->
        ...
        <input type="text" name="c_res" class="form-control" value="<?php echo $customer_res; ?>" required>
...
if(isset($_POST['update'])){
    ...
    $update_customer = "update customers set customer_name='$c_name',customer_email='$c_email',customer_campus='$c_campus',customer_res='$c_res',customer_address='$c_address',customer_contact='$c_contact',customer_image='$c_image' where customer_id='$update_id' ";
